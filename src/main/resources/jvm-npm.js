...
(function () {
  ...
  function Require (id, parent) {
    ...
    try {
//MHF disable caching for this implementation of require
...
//MHF  Require.root = System.getProperty('user.dir');
//MHF  Require.NODE_PATH = undefined;
  
  Require.root = SCRIPT_BASE;
  //var jfs = Java.type('java.nio.file.FileSystems');
  //Require.NODE_PATH = jfs.getDefault().getPath(SCRIPT_BASE,"node_modules").toString();
